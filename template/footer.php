...
<div class="row featurette footer">
  <footer style="background-color: #1a1e21" class="text-center text-white">
    ...
    <div class="container p-4">
      ...
      <section>
        ...
        <div class="divFooter">
          ...
          <a href="https://autogestion.produccion.gob.ar/consumidores" style="color: white"  target='blank'>Defensa al consumidor</a>
        </div> 
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
      Copyright © <span id='año-actual' style='display: flex'></p> Cata Food, Todos los derechos reservados.
    </div>
    <!-- Copyright -->
  </footer>
</div>
